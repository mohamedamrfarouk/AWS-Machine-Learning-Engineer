...
def test(model, test_loader,criterion, data_namee= "On testing_data:"):
    '''
...
def main(args):
    ...
    '''
    test(model, train_loader, criterion, "On Training dataset before training")   

    for epoch in range(1, args.epochs + 1):
        train(model, train_loader, criterion, optimizer, epoch)
        test(model, train_loader, criterion, "On Training dataset after the prev. epoch ")    

        test(model, validation_loader, criterion, "On Validation dataset")    
    '''
